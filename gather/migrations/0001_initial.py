    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inference_task', models.ForeignKey(help_text='The inference task in which this data was collected', on_delete=django.db.models.deletion.CASCADE, to='gather.inference_task')),
                ('subreddit', models.ForeignKey(help_text='The subreddit that was analyzed', on_delete=django.db.models.deletion.CASCADE, to='gather.subreddit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subreddit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gather.subreddit')),
                ('subreddit_result', models.ForeignKey(help_text='The collection that the user was a moderator during', on_delete=django.db.models.deletion.CASCADE, to='gather.subreddit_result')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_sub', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auth_from_sub', to='gather.subreddit_result')),
                ('inference_task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gather.inference_task')),
                ('to_sub', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auth_to_sub', to='gather.subreddit_result')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subreddit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gather.subreddit')),
                ('subreddit_result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gather.subreddit_result')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('weight', models.PositiveSmallIntegerField(help_text='The weight of the edge')),
                ('from_sub', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mod_from_sub', to='gather.subreddit_result')),
                ('inference_task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gather.inference_task')),
                ('to_sub', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mod_to_sub', to='gather.subreddit_result')),
            ],
            options={
